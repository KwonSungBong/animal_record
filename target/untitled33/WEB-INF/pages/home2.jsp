...
<div id="wrapper">
	<div id="header">
		<input id="search_name" type="text"/><button id="search">검색</button>
	</div>
	<div id="content">
			...
			<div class="l-col-half-4-left-of-right">
				<div class="head">
					<div class="l-right-group">
						<a id="save_post" class="">
							저장
						</a>
						<a id="update_post" class="">
							수정
						</a>
						<a id="create_post" class="">
							추가
						</a>
						<a id="destroy_post" class="">
							삭제
						</a>
					</div>
